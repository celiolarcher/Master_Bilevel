...
const double boundJ2[8]={-10e3,10e3,-10e3,15,0,10,0,10};  //Bounds x, y
...
const double boundJ3[10]={0,10e3,0,10e3,0,10e3,0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ4[8]={0,10e3,0,10e3,0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ6[8]={0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ7[8]={0,10e3,0,10e3,0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ8[4]={0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ9[6]={0,10e3,0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ10[8]={0,10e3,0,10e3,0.5,1.5,0.5,1.5};  //Bounds x, y
...
const double boundJ11[4]={0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ12[4]={0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ13[4]={0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ14[4]={0,10e3,0,10e3};  //Bounds x, y
...
const double boundJ16[4]={0,8,0,10e3};  //Bounds x, y
...
const double boundJ17[4]={0,8,0,10e3};  //Bounds x, y
...
//const double boundJ18[4]={-10e3,0,-10e3,0};  //Bounds x, y
const double boundJ18[4]={0,10e3,0,10e3};  //Bounds x, y

/* --------------------------------------------------------------------------------------------------------------------------------------*/

const FunctionJAQ listFunctionJaq[DEFINEfunctionListSizeJaq]={{1,1,0,3,0,3,boundJ1,funcJ1UP,funcJ1LW,funcJ1CTREQUP,funcJ1CTRNEQUP, funcJ1CTREQLW,funcJ1CTRNEQLW,funcJ1CTKKT,funcJ1SimplexTableauKKT,"funcJ1"},
					  {2,2,0,3,0,4,boundJ2,funcJ2UP,funcJ2LW,funcJ2CTREQUP,funcJ2CTRNEQUP, funcJ2CTREQLW,funcJ2CTRNEQLW,funcJ2CTKKT,funcJ2SimplexTableauKKT,"funcJ2"},
					  {2,3,0,0,0,8,boundJ3,funcJ3UP,funcJ3LW,funcJ3CTREQUP,funcJ3CTRNEQUP, funcJ3CTREQLW,funcJ3CTRNEQLW,funcJ3CTKKT,funcJ3SimplexTableauKKT,"funcJ3"},
					  {2,2,0,0,0,7,boundJ4,funcJ4UP,funcJ4LW,funcJ4CTREQUP,funcJ4CTRNEQUP, funcJ4CTREQLW,funcJ4CTRNEQLW,funcJ4CTKKT,funcJ4SimplexTableauKKT,"funcJ4"},
					  {2,2,0,1,0,10,boundJ5,funcJ5UP,funcJ5LW,funcJ5CTREQUP,funcJ5CTRNEQUP, funcJ5CTREQLW,funcJ5CTRNEQLW,funcJ5CTKKT,funcJ5SimplexTableauKKT,"funcJ5"},
					  {1,1,0,0,0,5,boundJ6,funcJ6UP,funcJ6LW,funcJ6CTREQUP,funcJ6CTRNEQUP, funcJ6CTREQLW,funcJ6CTRNEQLW,funcJ6CTKKT,funcJ6SimplexTableauKKT,"funcJ6"},
					  {2,2,0,1,0,6,boundJ7,funcJ7UP,funcJ7LW,funcJ7CTREQUP,funcJ7CTRNEQUP, funcJ7CTREQLW,funcJ7CTRNEQLW,funcJ7CTKKT,funcJ7SimplexTableauKKT,"funcJ7"},
					  {1,1,0,0,0,7,boundJ8,funcJ8UP,funcJ8LW,funcJ8CTREQUP,funcJ8CTRNEQUP, funcJ8CTREQLW,funcJ8CTRNEQLW,funcJ8CTKKT,funcJ8SimplexTableauKKT,"funcJ8"},
					  {1,2,0,0,0,7,boundJ9,funcJ9UP,funcJ9LW,funcJ9CTREQUP,funcJ9CTRNEQUP, funcJ9CTREQLW,funcJ9CTRNEQLW,funcJ9CTKKT,funcJ9SimplexTableauKKT,"funcJ9"},
					  {2,2,0,0,0,6,boundJ10,funcJ10UP,funcJ10LW,funcJ10CTREQUP,funcJ10CTRNEQUP, funcJ10CTREQLW,funcJ10CTRNEQLW,funcJ10CTKKT,funcJ10SimplexTableauKKT,"funcJ10"},
					  {1,1,0,1,0,3,boundJ11,funcJ11UP,funcJ11LW,funcJ11CTREQUP,funcJ11CTRNEQUP, funcJ11CTREQLW,funcJ11CTRNEQLW,funcJ11CTKKT,funcJ11SimplexTableauKKT,"funcJ11"},
					  {1,1,0,0,0,6,boundJ12,funcJ12UP,funcJ12LW,funcJ12CTREQUP,funcJ12CTRNEQUP, funcJ12CTREQLW,funcJ12CTRNEQLW,funcJ12CTKKT,funcJ12SimplexTableauKKT,"funcJ12"},
					  {1,1,0,0,0,6,boundJ13,funcJ13UP,funcJ13LW,funcJ13CTREQUP,funcJ13CTRNEQUP, funcJ13CTREQLW,funcJ13CTRNEQLW,funcJ13CTKKT,funcJ13SimplexTableauKKT,"funcJ13"},
					  {1,1,0,0,0,2,boundJ14,funcJ14UP,funcJ14LW,funcJ14CTREQUP,funcJ14CTRNEQUP, funcJ14CTREQLW,funcJ14CTRNEQLW,funcJ14CTKKT,funcJ14SimplexTableauKKT,"funcJ14"},
					  {1,2,0,0,0,8,boundJ15,funcJ15UP,funcJ15LW,funcJ15CTREQUP,funcJ15CTRNEQUP, funcJ15CTREQLW,funcJ15CTRNEQLW,funcJ15CTKKT,funcJ15SimplexTableauKKT,"funcJ15"},
					  {1,1,0,0,0,6,boundJ16,funcJ16UP,funcJ16LW,funcJ16CTREQUP,funcJ16CTRNEQUP, funcJ16CTREQLW,funcJ16CTRNEQLW,funcJ16CTKKT,funcJ16SimplexTableauKKT,"funcJ16"},
					  {1,1,0,3,0,3,boundJ17,funcJ17UP,funcJ17LW,funcJ17CTREQUP,funcJ17CTRNEQUP, funcJ17CTREQLW,funcJ17CTRNEQLW,funcJ17CTKKT,funcJ17SimplexTableauKKT,"funcJ17"},
					  {1,1,0,0,0,8,boundJ18,funcJ18UP,funcJ18LW,funcJ18CTREQUP,funcJ18CTRNEQUP, funcJ18CTREQLW,funcJ18CTRNEQLW,funcJ18CTKKT,funcJ18SimplexTableauKKT,"funcJ18"}
